    ...
    <div id="main-wrapper" class="main-wrapper">
        ...
        <section class="join_team py-60">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <h6 class="color-primary mb-8">–––– Tabla de Componentes</h6>
                        <h2 class="mb-16">Tabla de Componentes<!--<br> Drop Us <span class="fm-sec">Your CV!</span>-->
                        </h2>
                        <!--
                        ...
                        <div class="block mb-16">
                            ...
                            <!-- <ul class="unstyled rules"> -->
                                ...
                                <?php // endforeach; ?>
                            <!--</ul> 
                            <h5 class="mb-8">TEXTOS LITERARIOS CON CUESTIONARIO</h5>-->
                            <!--
                            <ul class="unstyled rules">
                                <?php   /*       
                            ...
                            <h5 class="mb-8">EJERCICIOS DE RAPIDEZ VISUAL</h5>-->
                            <!--
                            <ul class="unstyled rules">
                                <?php   /*       
                                   $text_lit=$base->query("SELECT * FROM textos_literarios")->fetchAll(PDO::FETCH_OBJ);
                            ...
                            <h5 class="mb-8">EJERCICIOS DE LOGICA LINGUISTICA</h5>-->
                            <!--
                            <ul class="unstyled rules">
                                <?php   /*       
                                   $text_lit=$base->query("SELECT * FROM textos_literarios")->fetchAll(PDO::FETCH_OBJ);
                            ...
                            <h5 class="mb-8">DATOS CURIOSOS</h5>-->
                            <!--
                            <ul class="unstyled rules">
                                <?php   /*       
                                   $text_lit=$base->query("SELECT * FROM textos_literarios")->fetchAll(PDO::FETCH_OBJ);
