...
<head>
    ...
    <title>Libros || Talleres de lectura comprensiva</title>
    ...
    <div id="main-wrapper" class="main-wrapper">
            ...
            <div class="container">
                <div class="row" id="accordionExample">
                    ...
                    <div class="col-lg-4">
                        ...
                        <form method="post" action="faq.html" class="form-validator">
                            <div class="mb-24">
        ...
        <footer>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-3 ">
                            <div class="footer_widget">
                                ...
                                <p class="description_text">Lorem ipsum dolor sit amet consectetur. Non convallis sed id
                                    aliquam tempus.
                        ...
                        <div class="col-xl-2 col-lg-3 col-sm-6">
                            <div class="footer_widget">
                                ...
                                <ul class="unstyled list">
                                    ...
                                    <li><a href="team-detail.html">Teacher’s Detail</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-sm-6">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="footer_widget">
                                ...
                                <ul class="unstyled list">
                                    <li class="mb-16"><i class="fal fa-map-marker-alt"></i>631 Elgin ST. Celina, State
                                        111111</li>
                    ...
                    <div class="bottom-row">
                        <ul class="unstyled social_icons_list">
                            <li><a href="#"><img src="assets/media/icons/brands/Instagram.png" alt=""></a></li>
                            <li><a href="#"><img src="assets/media/icons/brands/Facebook.png" alt=""></a></li>
                            <li><a href="#"><img src="assets/media/icons/brands/Twitter.png" alt=""></a></li>
                            <li><a href="#"><img src="assets/media/icons/brands/Linkedin.png" alt=""></a></li>
                        </ul>
                        <div class="newsletter_block">
                            <h5>Newsletter</h5>
                            <form class="newsletter">
                                <input type="email" class="form-control" required placeholder="Your email">
                                <button type="submit" class="educate-btn sm"><span
            ...
            <div class="copyright_row">
                <p>©2023 Educate All Rights Reserved.</p>
            </div>
        </footer>
        <!-- Footer Area End -->
