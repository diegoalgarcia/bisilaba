          ...
          <!-- App header ends -->
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-body">
                    <form action="ingresa_pdf_a_sub_contenido_tres.php" method="post" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="modal-content">
                          <div class="modal-body p-5 text-center">
                            ...
                            <div class="d-flex gap-2">
                              ...
                              <button type="button" onclick="location.href='lista_sub_items_tres.php?id_libro=<?php echo $id_libro; ?>'"  class="btn btn-lg btn-outline-dark w-100" data-bs-dismiss="modal">
                                Cancel
                              </button>
