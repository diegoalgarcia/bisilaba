...
<html lang="en">
  ...
  <head>
    ...
    <title>Dashboard - Ingreso Componentes nivel 2</title>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <div class="d-flex align-items-center ms-3">
              <h5 class="m-0">Formulario de registro de componentes </h5>
            </div>
            <!-- Breadcrumb ends -->
          ...
          <!-- App header ends -->
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-body">
                    <form action="registro_componentes.php" method="post"  class="row g-3 needs-validation" novalidate>
