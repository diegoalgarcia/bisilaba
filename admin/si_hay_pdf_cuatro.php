<?php
/*
  procedencia: lista_sub_items_cuatro.php del boton PDF
  destino: consulta en la base de datos
  
  funcionalidad: busca en la tabla sub_contenido_cuatro con el id del items
...
echo '<br>';
    ...
    $existe=$base->query("SELECT * FROM sub_contenido_cuatro WHERE id=$id_item")->fetchAll(PDO::FETCH_OBJ);
    ...
    if ($comprobarpdf == 'no') {
       ...
       header("location:form_ingreso_pdf_a_subitem_cuatro.php?id_libro=$id_libro&id_item=$id_item");
    }else {
