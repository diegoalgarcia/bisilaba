<?php  
      ...
      session_start();
       ...
       $contenido=$base->query("SELECT * FROM sub_contenido_dos WHERE id=$id_item")->fetchAll(PDO::FETCH_OBJ);
...
?>
<!--
   Procedencia: lista_portada.php desde el boton de sub item

   Descripcion de la funcionalidad del archivo:
   direccionar la data asociada a la portada_uno con la tabla sub_contenido_dos
                ...
                <div class="card mb-4">
                  ...
                  <!-- Parametro recibido del archivo lista_modulos -->
                      ...
                      <div class="d-grid m-3">
                          <a href="form_ingresa_items_a_contenido_tres.php?id_libro=<?php echo $id_libro; ?>&id_item=<?php echo $id_item; ?>" class="btn btn-info">
                                    ...
                                    <table class="table align-middle table-hover m-0 truncate">
                                      ...
                                      <tbody>
                                              <?php
                                                ...
                                                $subitem_s=$base->query("SELECT * FROM 	sub_contenido_tres WHERE id_item=$id_item")->fetchAll(PDO::FETCH_OBJ);
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                          <a class="btn btn-primary btn-sm" href="si_hay_pdf_tres.php?id_libro=<?php echo $id_libro; ?>&id_item=<?php echo $subitem->id; ?>" ><i class="bi bi-pencil"></i>
