...
<html lang="en">
  ...
  <head>
    ...
    <title>Dashboard - Ingreso contenido tematico</title>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <div class="d-flex align-items-center ms-3">
              <h5 class="m-0">Formulario de registro de contenido tematico </h5>
            </div>
            <!-- Breadcrumb ends -->
          ...
          <!-- App header ends -->
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-body">
                    <form action="registro_cont_tematico.php" method="post" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
