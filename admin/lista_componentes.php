...
<html lang="en">
  ...
  <head>
    ...
    <title>Dashboard - Listado Componentes</title>
          ...
          <div class="app-body">
            ...
            <div class="row">
              <div class="col-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Ingresar Componentes a la portada</h5>
                  </div>
                  <!-- Parametro recibido del archivo lista_modulos -->
                 
                  
                      <div class="d-grid m-3">
                          <a href="form_ingreso_componente.php?id_mod=<?php echo $id_mod; ?>" class="btn btn-info">
              ...
              <div class="col-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Listado Componentes de la portada</h5>
                  </div>
                  <div class="card-body">
                    <!-- inicio tabla -->
