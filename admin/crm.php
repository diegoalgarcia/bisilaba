...
<html lang="en">
  ...
  <head>
    ...
    <title>Admin Templates - Seven Bootstrap Admin Template</title>
  ...
  <body>
                    ...
                    <div class="m-0">
                      ...
                      <div class="position-relative">
                        ...
                        <span class="badge bg-primary-subtle text-primary small mb-1">
                          <i class="bi bi-exclamation-circle-fill me-1 text-danger"></i>3 pending orders
                        </span>
                        <div class=""><span class="badge bg-primary-subtle text-primary me-1">+28%</span>Compared to
                          last week</div>
                        <i class="bi bi-box-seam display-2 text-light position-absolute end-0 top-0 me-2"></i>
                      </div>
                      <div class="mt-3">
                  ...
                  <div class="card-body">
                    ...
                    <div class="m-0">
                      ...
                      <div class="position-relative">
                        <h2 class="m-0">$600</h2>
                        <span class="badge bg-primary-subtle text-primary small mb-1">
                          <i class="bi bi-exclamation-circle-fill me-1 text-danger"></i>4 new sales
                        </span>
                        <div class=""><span class="badge bg-primary-subtle text-primary me-1">+28%</span>Compared to
                          last week</div>
                        <i class="bi bi-bar-chart display-2 text-light position-absolute end-0 top-0 me-2"></i>
                      </div>
                      <div class="mt-3">
                  ...
                  <div class="card-body">
                    <div class="m-0">
                      ...
                      <div class="position-relative">
                        <h2 class="m-0">$800</h2>
                        <span class="badge bg-primary-subtle text-primary small mb-1">
                          <i class="bi bi-exclamation-circle-fill me-1 text-danger"></i>5 new orders
                        </span>
                        <div class=""><span class="badge bg-primary-subtle text-primary me-1">+36%</span>Compared to
                          last week</div>
                        <i class="bi bi-sticky display-2 text-light position-absolute end-0 top-0 me-2"></i>
                      </div>
                      <div class="mt-3">
                  ...
                  <div class="card-body">
                    <div class="m-0 text-white">
                      ...
                      <div class="position-relative">
                        ...
                        <i class="bi bi-wallet2 display-2 opacity-25 position-absolute end-0 top-0 me-2"></i>
                      </div>
                      <div class="mt-3">
    ...
    <script src="assets/vendor/apex/custom/crm/invoices.js"></script>
    <script src="assets/vendor/apex/custom/crm/deals.js"></script>
    <script src="assets/vendor/apex/custom/crm/tickets.js"></script>
    <script src="assets/vendor/apex/custom/crm/leads.js"></script>
