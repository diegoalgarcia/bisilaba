<?php  
       ...
       if(!isset($_SESSION["usuario"])){
          ...
          // se debe redireccionar a: 
       }
       include("conexion.php");
/* 
Procedencia: lista_sub_items_dos.php 
envia a: ingresa_item_a_contenido_dos.php
*/
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <div class="d-flex align-items-center ms-3">
              <h5 class="m-0">Formulario de ingreso de Sub Item a: <?php echo $item_portada; ?></h5>
            </div>
            <!-- Breadcrumb ends -->
          ...
          <!-- App header ends -->
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-body">
                    <form action="ingresa_item_a_contenido_cuatro.php" method="post" class="row g-3 needs-validation" novalidate>
