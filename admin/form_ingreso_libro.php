...
<html lang="en">
  ...
  <head>
    ...
    <title>Dashboard - Formulario ingreso módulos</title>
        ...
        <div class="app-container">
          ...
          <!-- App header starts -->
            <div class="app-header d-flex align-items-center">
                ...
                <h5 class="m-0">Formulario Módulos</h5>
                </div>
                <!-- Breadcrumb ends -->
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Formulario de ingreso de Módulos</h5>
                  </div>
                  <div class="card-body">
                    <!-- Row starts -->
                    ...
                    <div class="row gx-4">
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          ...
                          <input type="text" name="nombre" required class="form-control" placeholder="Ingrese Nombre del Módulo" >
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
