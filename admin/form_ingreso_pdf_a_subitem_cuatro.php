...
/* 
Procedencia: 
             -> lista_sub_items_tres.php -> boton pdf -> si_hay_pdf_tres.php -> valida no hay pdf ->
             form_ingreso_pdf_a_sub_item_tres.php
             -> 
destino: ingresa_pdf_a_sub_contenido_tres.php
          ...
          <!-- App header ends -->
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-body">
                    <form action="ingresa_pdf_a_sub_contenido_cuatro.php" method="post" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="modal-content">
                          <div class="modal-body p-5 text-center">
                            ...
                            <div class="d-flex gap-2">
                              ...
                              <button type="button" onclick="location.href='lista_sub_items_cuatro.php?id_libro=<?php echo $id_libro; ?>'"  class="btn btn-lg btn-outline-dark w-100" data-bs-dismiss="modal">
                                Cancel
                              </button>
