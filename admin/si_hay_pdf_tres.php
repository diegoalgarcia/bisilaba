<?php
/*
  procedencia: lista_sub_items_tres.php del boton PDF
  destino: consulta en la base de datos
  
  funcionalidad: busca en la tabla sub_contenido_tres con el id del items
...
echo '<br>';
    ...
    $existe=$base->query("SELECT * FROM sub_contenido_tres WHERE id=$id_item")->fetchAll(PDO::FETCH_OBJ);
    ...
    if ($comprobarpdf == 'no') {
       ...
       header("location:form_ingreso_pdf_a_subitem_tres.php?id_libro=$id_libro&id_item=$id_item");
    }else {
