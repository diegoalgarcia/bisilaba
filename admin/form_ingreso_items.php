...
<html lang="en">
  ...
  <head>
    ...
    <title>Dashboard - Formulario ingreso Ìtem</title>
        ...
        <div class="app-container">
          ...
          <!-- App header starts -->
            <div class="app-header d-flex align-items-center">
                ...
                <h5 class="m-0">Formulario ingreso de Ítems</h5>
                </div>
                <!-- Breadcrumb ends -->
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Formulario de ingreso de Ítem</h5>
                  </div>
                  <div class="card-body">
                    <!-- Row starts -->
                  <form action="ingreso_item.php" method="post" class="form-validator">
                    <div class="row gx-4">
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label">Nombre</label>
                          <input type="text" name="titulo" required class="form-control" placeholder="Ingrese Nombre del Ítem" >
                        </div>
                      </div>
                      <!--
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          ...
                          <input type="text" name="titulo" required class="form-control" placeholder="Ingrese título">
                        </div>
                      </div>
                      -->
                    </div>
