...
<html lang="en">
  ...
  <head>
    ...
    <title>HELISE : Panel de Control</title>
      ...
      <div class="main-container">
        ...
        <div class="app-container">
              ...
              <div class="dropdown ms-4">
                <a id="userSettings" class="dropdown-toggle d-flex py-2 align-items-center" href="#!" role="button"
                  ...
                  <div class="ms-2 text-truncate d-lg-flex flex-column d-none">
                    <p class="text-truncate m-0">Nombre Admin</p>
          ...
          <div class="app-footer">
            <span class="small">Gestion contenido: Ing Diego Alejandro García -- © Bootstrap Gallery 2024</span>
          </div>
          <!-- App footer ends -->
