<?php  
      ...
      session_start();
       ...
       $contenido=$base->query("SELECT * FROM sub_contenido_tres WHERE id=$id_item")->fetchAll(PDO::FETCH_OBJ);
...
?>
<!--
   Procedencia: lista_sub_items_tres.php desde el boton de sub item

   Descripcion de la funcionalidad del archivo:
   direccionar la data asociada a la portada_uno con la tabla sub_contenido_tres

   1. Debe enviar al formulario de ingreso de  sub items
   2. Debe mostrar (listar) los registros (sub items) ingresados mediante formulario
   4. Debe enviar al formulario de ingreso de documentos pdf 
   3. Mediante boton PDF muestra los documentos pdf asociados 

   secuencia para ver lista de modulos:
   ------------------------------------
   index.php -> lista_libros.php -> lista_portada.php -> lista_sub_items_dos.php -> lista_sub_items_tres.php -> lista_sub_items_cuatro.php

   secuencia para ver lista de items (contenido) de la portada o primer nivel:
   ------------------------------------
   index.php -> lista_libros.php -> lista_portada.php 

   secuencia para ver lista de sub items (contenido) de la portada o segundo nivel:
   ------------------------------------
   index.php -> lista_libros.php -> lista_portada.php -> lista_sub_items_dos.php y despues de archivo php a la tabla sub_contenido_dos
...
<html lang="en">
  ...
  <head>
    ...
    <title>Dashboard - Lista Sub Ítems</title>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <div class="d-flex align-items-center ms-3">
              <h5 class="m-0">Listado de Sub Ítems de la Portada del Módulo <?php echo $texto; ?></h5>
            </div>
            <!-- Breadcrumb ends -->
            ...
            <div class="row">
              <div class="col-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Ingresar Items (Títulos) <?php echo $item_portada; ?></h5>
                  </div>
                  <!-- Parametro recibido del archivo lista_modulos -->
                 
                  
                      <div class="d-grid m-3">
                          <a href="form_ingresa_items_a_contenido_cuatro.php?id_libro=<?php echo $id_libro; ?>&id_item=<?php echo $id_item; ?>" class="btn btn-info">
             ...
             <!--
              ...
              <div class="col-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Listado de sub titulos de <?php echo $item_portada; ?></h5>
                  </div>
                  <div class="card-body">
                    <!-- inicio tabla -->
                                    ...
                                    <table class="table align-middle table-hover m-0 truncate">
                                      ...
                                      <tbody>
                                              <?php
                                                ...
                                                $subitem_s=$base->query("SELECT * FROM sub_contenido_cuatro WHERE id_item=$id_item")->fetchAll(PDO::FETCH_OBJ);
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                          <a class="btn btn-primary btn-sm" href="si_hay_pdf_cuatro.php?id_libro=<?php echo $id_libro; ?>&id_item=<?php echo $subitem->id; ?>" ><i class="bi bi-pencil"></i>
                                      ...
                                      --></a>
                                          ...
                                          <td>
                                            <a class="btn btn-primary btn-sm" href="lista_sub_items_cuatro.php?id_libro=<?php echo $id_libro; ?>&id_item=<?php echo $subitem->id; ?>"><i class="bi bi-pencil"></i>
                                            </a>
                                          </td><!--
                                          <td>
